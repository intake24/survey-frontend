...
public class ShowNextPortionSizeStepFlexibleRecall implements PromptRule<FoodEntry, FoodOperation> {
    ...
    public ShowNextPortionSizeStepFlexibleRecall(PortionSizeScriptManager scriptManager) {
    ...
    public static WithPriority<PromptRule<FoodEntry, FoodOperation>> withPriority(PortionSizeScriptManager scriptManager, int priority) {
        return new WithPriority<PromptRule<FoodEntry, FoodOperation>>(new ShowNextPortionSizeStepFlexibleRecall(scriptManager), priority);
    }
}