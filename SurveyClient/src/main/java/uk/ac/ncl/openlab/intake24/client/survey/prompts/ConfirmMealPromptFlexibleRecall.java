...
public class ConfirmMealPromptFlexibleRecall implements Prompt<Meal, MealOperation> {
    ...
    public static String selectPromptMessage(String mealName) {
        if (compareCaseInsensitive(mealName, messages.predefMeal_Breakfast()))
            ...
            return messages.confirmMeal_promptText_generic(SafeHtmlUtils.htmlEscape(toLowerCase(mealName)), SafeHtmlUtils.htmlEscape(capitaliseFirstCharacter(mealName)));
    }
    ...
    public SurveyStageInterface getInterface(final Callback1<MealOperation> onComplete,
        ...
        TimeQuestionFlexibleRecall timeQuestion = new TimeQuestionFlexibleRecall(promptText, acceptText, skipText, initialTime, new TimeQuestionFlexibleRecall.ResultHandler() {
            @Override
        ...
        return new SurveyStageInterface.Aligned(content, HasHorizontalAlignment.ALIGN_LEFT, HasVerticalAlignment.ALIGN_TOP, SurveyStageInterface.DEFAULT_OPTIONS, ConfirmMealPromptFlexibleRecall.class.getSimpleName());
    }
