...
public class RuleBasedPromptManager implements PromptManager {
	...
	public Option<Prompt<Survey, SurveyOperation>> nextPromptForSelection(final Survey state) {
		return state.selectedElement.accept(new Selection.Visitor<Option<Prompt<Survey, SurveyOperation>>>() {
			@Override
			public Option<Prompt<Survey, SurveyOperation>> visitMeal(final Selection.SelectedMeal meal) {
			...
			@Override
			public Option<Prompt<Survey, SurveyOperation>> visitFood(final Selection.SelectedFood food) {
			...
			@Override
			public Option<Prompt<Survey, SurveyOperation>> visitNothing(final Selection.EmptySelection selection) {
