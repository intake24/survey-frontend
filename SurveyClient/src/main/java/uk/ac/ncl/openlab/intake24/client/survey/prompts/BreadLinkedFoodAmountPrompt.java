...
import uk.ac.ncl.openlab.intake24.client.survey.rules.ShowBreadLinkedFoodAmountPrompt;
...
public class BreadLinkedFoodAmountPrompt implements Prompt<Pair<FoodEntry, Meal>, MealOperation> {
    ...
    private final static PVector<ShepherdTour.Step> shepherdTour = TreePVector.<ShepherdTour.Step>empty()
