...
import uk.ac.ncl.openlab.intake24.client.CallbackRequestForm;
...
public class ShepherdTour {
	...
	private static native JavaScriptObject createTour() /*-{
		...
		tour.on("complete", function() {
			...
			@uk.ac.ncl.openlab.intake24.client.survey.ShepherdTour::onTourComplete()();
		});
	...
	private static native JavaScriptObject firstStepButtons(JavaScriptObject tour) /*-{
		return [ {
			text : @uk.ac.ncl.openlab.intake24.client.survey.ShepherdTour::exitButtonLabel,
			classes : 'shepherd-button-secondary',
			action : tour.cancel
		}, {
			text : @uk.ac.ncl.openlab.intake24.client.survey.ShepherdTour::nextButtonLabel,
			action : tour.next
		} ];
	...
	private static native JavaScriptObject lastStepButtons(JavaScriptObject tour) /*-{
		return [ {
			text : @uk.ac.ncl.openlab.intake24.client.survey.ShepherdTour::stillStuckButtonLabel,
			classes : 'shepherd-button-red',
			action : function() {
				tour.cancel();
				@uk.ac.ncl.openlab.intake24.client.survey.ShepherdTour::requestCallBack(Ljava/lang/String;)(tour.intake24_promptType);
			}
		}, {
			text : @uk.ac.ncl.openlab.intake24.client.survey.ShepherdTour::backButtonLabel,
			action : tour.back
		}, {
			text : @uk.ac.ncl.openlab.intake24.client.survey.ShepherdTour::doneButtonLabel,
			action : tour.next
		} ];
	}-*/;
