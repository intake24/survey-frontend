...
public class TextAreaPrompt implements SimplePrompt<String> {
    ...
    public FlowPanel getInterface(final Callback1<String> onComplete) {
        ...
        TextAreaQuestion textAreaQuestion = new TextAreaQuestion(promptText);
        content.add(textAreaQuestion);
        ...
        final Button finish = WidgetFactory.createGreenButton(helpMessages.textarea_continueButtonTitle(), "textareaContinueButton", new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                Option<String> answer = textAreaQuestion.getAnswer(true);
                if (!answer.isEmpty())
