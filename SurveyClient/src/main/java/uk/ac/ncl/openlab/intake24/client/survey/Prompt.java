 ...
 *
 * @param <T>  The type of the elements this prompt is applicable to, i.e.
 *             FoodEntry or Meal.
 * @param <Op> The type of operation that this prompt applies to the element, can
 *             be FoodOperation, MealOperation or SurveyOperation.
 */
public interface Prompt<T, Op> {
    /**
     * @param onComplete              Will be called when the user interaction is complete and there is
     *                                an operation to be applied to the element.
     * @param updateIntermediateState Will be called when the user interaction is not yet complete but
