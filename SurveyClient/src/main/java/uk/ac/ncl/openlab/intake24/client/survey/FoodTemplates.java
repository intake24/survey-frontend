...
public class FoodTemplates {
    ...
    public static final TemplateFoodData sandwich = new TemplateFoodData("sandwich", TreePVector.<TemplateFoodData.ComponentDef>empty()
    ...
    public static final TemplateFoodData salad = new TemplateFoodData("salad", TreePVector.<TemplateFoodData.ComponentDef>empty()
            .plus(new TemplateFoodData.ComponentDef(
                    ...
                    "SLW1", simpleHeader("scran24-salad-wizard-stage1"), TemplateFoodData.ComponentOccurence.Multiple, TemplateFoodData.ComponentType.Required))
            .plus(new TemplateFoodData.ComponentDef(
                    ...
                    "SLW2", simpleHeader("scran24-salad-wizard-stage2"), TemplateFoodData.ComponentOccurence.Single, TemplateFoodData.ComponentType.Optional)));
