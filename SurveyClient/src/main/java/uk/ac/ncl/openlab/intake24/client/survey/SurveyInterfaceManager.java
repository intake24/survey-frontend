...
public class SurveyInterfaceManager {
    ...
    /**
     * @param container The container Panel that will contain survey page UI elements.
    ...
    /**
     * @param onComplete                Called when user has finished interacting with the current survey page
     *                                  (e.g. by clicking continue). The Survey parameter is the updated Survey state.
     * @param onIntermediateStateChange Called when the user has not finished interacting with the current page,
    ...
    public void show(SurveyStage<Survey> stage) {
        ...
        //interf.content.getElement().setAttribute("data-prompt-type", );
