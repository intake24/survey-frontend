    ...
    public Option<Prompt<Survey, SurveyOperation>> apply(Survey survey, SelectionMode selectionType, PSet<String> surveyFlags) {
        if (!survey.flags.contains(AskAboutProxy.PROXY_COMPLETE) && survey.portionSizeComplete()) {
            ...
            SafeHtml promptText = SafeHtmlUtils.fromSafeConstant(
                    "<p>Did you have any difficulties in recording foods or amounts eaten because you were " +
                            "completing this for someone else?</p>" +
                            "<p>For example, occasions when your child was not in your care and you are unsure " +
                            "of the details of a particular food or an entire meal (e.g. type and amount).</p>"
            );
