...
import static uk.ac.ncl.openlab.intake24.client.LocaleUtil.capitaliseFirstCharacter;
import static uk.ac.ncl.openlab.intake24.client.LocaleUtil.compareCaseInsensitive;
import static uk.ac.ncl.openlab.intake24.client.LocaleUtil.toLowerCase;
...
public class ConfirmMealPrompt implements Prompt<Meal, MealOperation> {
	...
	public SurveyStageInterface getInterface(final Callback1<MealOperation> onComplete,
		...
		return new SurveyStageInterface.Aligned(content, HasHorizontalAlignment.ALIGN_LEFT, HasVerticalAlignment.ALIGN_TOP, SurveyStageInterface.DEFAULT_OPTIONS, ConfirmMealPrompt.class.getSimpleName());
	}
