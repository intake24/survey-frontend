...
import uk.ac.ncl.openlab.intake24.client.survey.scheme.ndns.ConfirmFoodSupplements;
import uk.ac.ncl.openlab.intake24.client.survey.scheme.ndns.ListFoodSupplements;
import uk.ac.ncl.openlab.intake24.client.survey.scheme.ndns.AskAboutProxy;
import uk.ac.ncl.openlab.intake24.client.survey.scheme.ndns.AskAboutProxyIssues;

import java.util.Date;

public class FSSIntakeChildren extends BasicScheme {

    public static final String ID = "fss_intake_children";
    private static final double MAX_AGE_HOURS = 12.0;

    public FSSIntakeChildren(String locale, SurveyParameters surveyParameters, final SurveyInterfaceManager interfaceManager, UserData userData) {
    ...
    protected Rules getRules(PortionSizeScriptManager scriptManager, CompoundFoodTemplateManager templateManager, RecipeManager recipeManager) {
        ...
        return new Rules(
                ...
                baseRules.surveyPromptRules
                        ...
                        .plus(ConfirmFoodSupplements.withPriority(28))
                        .plus(ListFoodSupplements.withPriority(27))
                        .plus(AskAboutProxy.withPriority(26))
                        .plus(AskAboutProxyIssues.withPriority(25)),
