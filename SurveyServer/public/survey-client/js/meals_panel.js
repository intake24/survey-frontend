...
function doResize() {
    ...
    var headerHeight = $(".intake24-header-container").outerHeight(true);
    var navbarHeight = $(".intake24-navbar-container").outerHeight(true);
    var footerHeight = $(".intake24-footer-container").outerHeight(true);
